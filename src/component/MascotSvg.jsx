const MascotSvg = () => {
    return (
        <svg xmlns="http://www.w3.org/2000/svg" width="80" height="64" fill="none" className="sc-kpDqfm hZeYaj">
                <path fill="#FFD530" d="M75.538 76.358s-.678-12.34-9.182-25.508H21.221L21 57.5"/>
                <path stroke="#2A2D34" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
                      d="M75.538 76.358s-.678-12.34-9.182-25.508H21.221L21 57.5"/>
                <path fill="#FFD530" d="M23.903 49.471S18.77 29.948 10.172 28.843C1.168 27.683-.855 42.697 20 61"/>
                <path stroke="#2A2D34" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
                ...
                <path fill="#FFD530" stroke="#2A2D34" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
                      d="m46.44 58.62-1.41 1.41a1.753 1.753 0 0 1-2.48 0l-1.41-1.41a1.753 1.753 0 0 1 0-2.48l1.41-1.41a1.753 1.753 0 0 1 2.48 0l1.41 1.41a1.753 1.753 0 0 1 0 2.48Z"/>
                <path fill="#fff"
                      d="M73.766 18.37C67.816 3.143 52.322 1.495 43.87 1.48h-.162c-8.453.015-23.945 1.663-29.898 16.89-7.636 19.537 7.512 29.359 7.512 29.359a54.56 54.56 0 0 0 22.466 4.52A54.692 54.692 0 0 0 56.125 51a54.642 54.642 0 0 0 10.13-3.272s15.148-9.822 7.511-29.359Z"/>
                <path fill="#FFD530"
                ...
                <path fill="#2DC275" stroke="#2A2D34" strokeMiterlimit="10"
                      d="m46.697 22.845.034-.039c.795-.904.352-2.312-.816-2.612-.741-.192-1.543-.246-2.129-.249-.583 0-1.387.055-2.129.247-1.168.3-1.613 1.706-.818 2.61l.034.04c1.55 1.736 4.278 1.738 5.824.003Z"/>
                <path fill="#2A2D34"
                      d="M32.41 19.945a.525.525 0 0 0-.506.651 2.804 2.804 0 0 0 5.456 0 .525.525 0 0 0-.507-.65H32.41ZM55.17 19.945c.339 0 .585.321.506.651a2.804 2.804 0 0 1-5.456 0 .525.525 0 0 1 .507-.65h4.443Z"/>
                <path stroke="#2A2D34" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
